...
public class VentanaGastos extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VentanaGastos(Aplicacion control) {
		app=control;
		...
		button.setIcon(new ImageIcon("C:\\Users\\Azhala\\git\\repositorio\\ManagmentStore\\Iconos\\Coin-icon.png"));
		button.setToolTipText("A\u00F1ade Gasto");
		...
		button_4.setIcon(new ImageIcon("C:\\Users\\Azhala\\git\\repositorio\\ManagmentStore\\Iconos\\Cash-register-icon.png"));
		button_4.setToolTipText("Reporte de gastos");
